...
# num_segments = int(Num_Samples * 1e3 /1024 *units.KiS )                                                          # One segment per pulse 
# samples_per_segment = int(Num_Samples * 1e3 /1024 *units.KiS )                                          # Each segment has the right amount
...
# multiple_recording.memory_size(num_segments)
# tot_samp = multiple_recording.allocate_buffer(samples_per_segment)
...
# bpn = Range * BPulseFreq*2 * 1e-3
# shift = int(samples_per_segment/bpn)
# post  = multiple_recording.post_trigger(samples_per_segment - shift)
